...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2022 at 12:55 PM
...
(234, 2, 6, 4, 'Otobi smart table', NULL, NULL, 'OTOBI', 'NC20', '7', NULL, '2022-11-01 00:00:00', '5', NULL, 7, NULL, NULL);
...
CREATE TABLE `product_requisitions` (
  ...
  `requested_to` int(10) DEFAULT NULL COMMENT 'requested to user id',
  `direct_requested_to_head_office` int(100) NOT NULL DEFAULT 0,
...
INSERT INTO `product_requisitions` (`id`, `item_category_id`, `product_category_id`, `inventory_product_id`, `branch_id`, `brand`, `model`, `quantity`, `warranty`, `requisition_request_date`, `requested_from`, `requested_to`, `direct_requested_to_head_office`, `requisition_current_status`, `status_by_branch_manager`, `status_by_head_office`, `requisition_decline_reason`, `created_at`, `updated_at`) VALUES
(1, 5, 8, 4, 10, 'ZZap', 'NC20', 2, 12, '2022-10-19', 9, 3, 0, 3, 2, 0, 'henlo', NULL, NULL),
(2, 8, 3, 1, 10, 'Samsung', 'LS32AM700UWXXL', 4, 5, '2022-10-19', 2, 3, 0, 4, 1, 1, NULL, NULL, NULL),
(4, 2, 5, 5, 10, 'HATIL', 'HCL-201', 15, 15, '2022-10-26', 9, 3, 0, 3, 1, 2, 'amnei', NULL, '2022-10-26 11:33:49'),
(5, 6, 14, 8, 10, NULL, NULL, 4, 3, '2022-10-29', 9, 3, 0, 4, 1, 1, NULL, NULL, NULL),
(6, 6, 15, 78, 10, NULL, NULL, 74, 3, '2022-10-30', 9, 3, 0, 4, 1, 1, NULL, NULL, '2022-10-30 11:11:13'),
(7, 6, 16, 227, 10, NULL, NULL, 90, 5, '2022-10-30', 2, 3, 0, 4, 1, 1, NULL, NULL, '2022-10-30 11:24:40'),
(10, 6, 16, 231, 4, NULL, NULL, 888888888, 5, '2022-11-01', 10, NULL, 7, 4, 1, 1, NULL, NULL, NULL),
(11, 6, 15, 96, 1, NULL, NULL, 999, 3, '2022-11-01', 8, 4, 0, 4, 1, 1, NULL, NULL, '2022-11-01 09:52:57'),
(12, 6, 16, 227, 4, NULL, NULL, 789, 5, '2022-11-01', 10, NULL, 7, 3, 1, 2, 'over quantity', NULL, '2022-11-01 11:21:09'),
(13, 6, 14, 1, 4, NULL, NULL, 34, 3, '2022-11-01', 7, NULL, 10, 4, 1, 1, NULL, NULL, '2022-11-01 11:20:00'),
(14, 2, 6, 234, 1, 'OTOBI', 'NC20', 1, 5, '2022-11-01', 8, 4, 0, 4, 1, 1, NULL, NULL, '2022-11-01 11:16:05'),
(15, 6, 15, 75, 10, NULL, NULL, 4, 3, '2022-11-01', 2, 3, 0, 4, 1, 1, NULL, NULL, '2022-11-01 11:48:26'),
(16, 6, 14, 14, 1, NULL, NULL, 5, 3, '2022-11-01', 8, 4, 0, 4, 1, 1, NULL, NULL, NULL),
(17, 6, 15, 128, 4, NULL, NULL, 9, 3, '2022-11-01', 10, NULL, 7, 4, 1, 1, NULL, NULL, NULL),
(18, 6, 14, 64, 4, NULL, NULL, 4, 3, '2022-11-01', 7, NULL, 10, 3, 1, 2, 'over', NULL, '2022-11-01 11:51:52');
...
(10, 4, 2, 'Mr. Asif Khan', 'Head Office', 'asif@gmail.com', '01513470120', NULL, '$2y$10$ZLxbBF3u.ex21/ygphODrOCqM/haS7kzjrZARGCAchVHfsfpJhnB.', NULL, NULL, NULL);
