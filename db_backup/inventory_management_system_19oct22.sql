...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2022 at 12:12 PM
...
INSERT INTO `product_requisitions` (`id`, `item_category_id`, `product_category_id`, `inventory_product_id`, `branch_id`, `brand`, `model`, `quantity`, `warranty`, `requisition_request_date`, `requested_from`, `requested_to`, `requisition_current_status`, `created_at`, `updated_at`) VALUES
(1, 5, 8, 4, 10, 'ZZap', 'NC20', 2, 12, '2022-10-19', 9, 3, 1, NULL, NULL),
(2, 8, 3, 1, 10, 'Samsung', 'LS32AM700UWXXL', 4, 5, '2022-10-19', 2, 3, 1, NULL, NULL),
(3, 2, 12, 2, 1, 'OTOBI', 'CSEP006FRAA010', 5, 9, '2022-10-19', 8, 4, 1, NULL, NULL);
...
(3, 'Denied', '2022-10-17 07:13:20', '2022-10-17 07:13:20'),
