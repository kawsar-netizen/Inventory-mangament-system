...
@section('content_ims')
    ...
    <main id="js-page-content" role="main" class="page-content">
        <div class="row" style="margin-left: 80px; margin-right: 80px; margin-top:50px;">
            <div class="col-xl-12 col-md-7 sortable-grid ui-sortable">
                <div id="panel-3" class="panel panel-sortable" role="widget">
                    ...
                    <div class="panel-container show" role="content">
                        ...
                        <div class="panel-content">
                            ...
                            <form id="transaction_create_from" action="{{ route('user.store') }}"
                                method="post"enctype="multipart/form-data" novalidate="novalidate" autocomplete="off">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" placeholder="Enter user type" name="type"
                                                id="type" class="form-control" required="" aria-required="true"
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" placeholder="Enter user contact number" name="contact_phone"
                                                id="contact_phone" class="form-control" required="" aria-required="true"
                                                value="{{ old('contact_phone') }}" autocomplete="off">
                                            <span style="color: red">
                                                @error('contact_phone')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="email" placeholder="Enter user email address" name="email"value="{{ old('email') }}"
                                                id="br_address" class="form-control" required="" aria-required="true">
                                            <span style="color: red">
                                                @error('email')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="password" name="password" class="form-control" id="password"
                                                required="" aria-required="true" placeholder="Enter user password">
                                            <span style="color: red">
                                                @error('password')
                                                    {{ $message }}
                                                @enderror
